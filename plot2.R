...
# This r-Script reads in data from Local Working Directory and genrates a line plot of "Global Active Power" over a time span of 2 days 
...
#plot line plot of "Global Active Power"
with(o,plot(datetime,Global_active_power,type="l", ylab="Global active power (kilowatts)", xlab=""))
